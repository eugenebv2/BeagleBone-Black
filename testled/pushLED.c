...
int main() {
  FILE *fpbutton, *fpLED;
  char LED[] = "51";   // Look up P9.16 using gpioinfo | grep -e chip -e P9.16.  chip 1, line 19 maps to 51
  char button[] = "50"; // Look up P9.14 using gpioinfo | grep -e chip -e P9.14.  chip 1, line 18 maps to 50
