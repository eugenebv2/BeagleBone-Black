...
int main(void)
{
	...
	buf[2] = 0x50; // 0x30 will be stored in location 0x51
	buf[3] = 0x51; // 0x31 will be stored in location 0x52
	buf[4] = 0x52; // 0x32 will be stored in location 0x53
	buf[5] = 0x53; // 0x33 will be stored in location 0x54
	buf[6] = 0x54; // 0x34 will be stored in location 0x55
	buf[7] = 0x55; // 0x35 will be stored in location 0x56
	buf[8] = 0x56; // 0x36 will be stored in location 0x57
	buf[9] = 0x57; // 0x37 will be stored in location 0x58
	buf[10] = 0x58;
